...
const LogoMain = ({ reverse, ...others }: { reverse?: boolean }) => {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', lineHeight: '1', ...others }}>
      <svg width="43" height="43" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '6px' }}>
        <path
