...
const LogoMain = ({ reverse, ...others }: { reverse?: boolean }) => {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', ...others }}>
      <svg width="115" height="115" viewBox="-1.2 -1.2 14.4 14.4" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '8px' }}>
        <path
      ...
      <span style={{ fontSize: '24px', color: theme.palette.mode === 'dark' || reverse ? theme.palette.common.white : theme.palette.common.black }}>
        跨越长城
      </span>
    </div>
  );
