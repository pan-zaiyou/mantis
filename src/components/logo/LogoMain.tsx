...
const LogoMain = ({ reverse, ...others }: { reverse?: boolean }) => {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', ...others }}>
      <svg width="50" height="50" viewBox="-1.2 -1.2 14.4 14.4" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '2px', position: 'relative', top: '2px' }}>
        <path
      ...
      <span style={{ fontSize: '20px', fontWeight: 'bold', color: theme.palette.mode === 'dark' || reverse ? theme.palette.common.white : theme.palette.common.black, position: 'relative', top: '2px', lineHeight: '50px' }}>
        跨越长城
      </span>
    </div>
  );
